        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/mughadrahtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-مغادرة/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'ماليزيا - 8 ايام 7 ليالي'],
        image_2: ['عروض-شركة-مغادرة/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'ماليزيا - 10 ايام 9 ليالي'],
        image_3: ['عروض-شركة-مغادرة/عروض-ماليزيا/عرض-ماليزيا-3.jpg', 'ماليزيا - 9 ايام 8 ليالي'],
    },

    {
        title: 'عروض المالديف',
        image_1: ['عروض-شركة-مغادرة/عروض-المالديف/عرض-المالديف-1.jpg', 'المالديف - منتجع Kandima'],
        image_2: ['عروض-شركة-مغادرة/عروض-المالديف/عرض-المالديف-2.jpg', 'المالديف - منتجع Breinnia Kottefaru'],
        image_3: ['عروض-شركة-مغادرة/عروض-المالديف/عرض-المالديف-3.jpg', 'المالديف - منتجع Hard Rock'],
        image_4: ['عروض-شركة-مغادرة/عروض-المالديف/عرض-المالديف-4.jpg', 'المالديف - منتجع Noku'],
        image_5: ['عروض-شركة-مغادرة/عروض-المالديف/عرض-المالديف-5.jpg', 'المالديف - منتجع Lux South Ari Atoll'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-مغادرة/عروض-تايلاند/عرض-تايلاند-1.jpg', 'تايلاند - بانكوك & بوكيت'],
    },
    ...
    {
        title: 'عروض موريشيوس',
        image_1: ['عروض-شركة-مغادرة/عروض-موريشيوس/عرض-موريشيوس-1.jpg', 'موريشيوس - برنامج سياحي فاخر'],
        image_2: ['عروض-شركة-مغادرة/عروض-موريشيوس/عرض-موريشيوس-2.jpg', 'موريشيوس - 8 ايام 7 ليالي'],
        image_3: ['عروض-شركة-مغادرة/عروض-موريشيوس/عرض-موريشيوس-3.jpg', 'موريشيوس - 8 ايام 7 ليالي'],
    },


    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-مغادرة/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'اذربيجان - باكو & قوبا'],
        image_2: ['عروض-شركة-مغادرة/عروض-اذربيجان/عرض-اذربيجان-2.jpg', 'اذربيجان - باكو & قابالا'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966559955539?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/mughadrahtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة مغادرة على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة مغادرة على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة مغادرة على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة مغادرة للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة مغادرة للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة مغادرة`;
            img.title = `مكتب سياحي - شركة مغادرة`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966559955539";
